<<<<<<< HEAD:TCP_many_to_many/client/src/network/myRDMA.cpp
#include "tcp.hpp"
#include "RDMA.hpp"
#include "myRDMA.hpp"
#include <time.h>
...
>>>>>>> bench:benchmarking/client/src/network/myRDMA.cpp
...
void myRDMA::Send_RDMA(char *msg, int i,char *name){
>>>>>>> bench:benchmarking/client/src/network/myRDMA.cpp
    RDMA rdma;
    TCP tcp;
    if(strcmp(msg,"exit\n")==0)
...
=======
        fgets(msg, BufSize, stdin);
        if(thread_cnt != socks_cnt && strcmp(msg,"exit\n")!=0){
            cout << "exit가 아닙니다."<<endl;
>>>>>>> bench:benchmarking/client/src/network/myRDMA.cpp
            continue;
        }*/
