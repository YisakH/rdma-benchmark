...
class myRDMA{
    public:
        ...
        void write_rdma(char *msg, int i, int msg_size, vector<pair<struct timeval, struct timeval>> *bench_time);
        void read_rdma(char *msg, int i, int msg_size, vector<pair<struct timeval, struct timeval>> *bench_time);
